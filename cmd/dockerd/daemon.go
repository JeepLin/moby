...
import (
	...
	"moby/api"
	apiserver "moby/api/server"
	buildbackend "moby/api/server/backend/build"
	"moby/api/server/middleware"
	"moby/api/server/router"
	"moby/api/server/router/build"
	checkpointrouter "moby/api/server/router/checkpoint"
	"moby/api/server/router/container"
	distributionrouter "moby/api/server/router/distribution"
	"moby/api/server/router/image"
	"moby/api/server/router/network"
	pluginrouter "moby/api/server/router/plugin"
	sessionrouter "moby/api/server/router/session"
	swarmrouter "moby/api/server/router/swarm"
	systemrouter "moby/api/server/router/system"
	"moby/api/server/router/volume"
